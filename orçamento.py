...
revestimento_1 = (parede_1 + parede_2 + parede_3 + parede_4 )
cimento_cola = 1.5 * (revestimento_1 + piso) 
rejunto = (revestimento_1 + piso ) / 3
m_o = float(input('Digite o valor da mão de obra por m2 : R$ '))
print(f'Total revestimento da parede {revestimento_1:.2f} m2')
print(f'Total cimento cola {cimento_cola} sacos')
print(f" total de rejunto {rejunto:.2f} kilos")
